...
public class PalindromicSubstrings {
    ...
    */
     ...
     *
     * For each center, let's neighborCount all the palindromes that have this center. Notice that if [a, b] is a
     ...
     * want to neighborCount a new palindrome S[left], S[left+1], ..., S[right].
     *
     * @param S
     * @return
     */
